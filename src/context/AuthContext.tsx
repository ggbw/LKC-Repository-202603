...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const primaryRole: AppRole = isAdmin ? 'admin' : isHOD ? 'hod' : isHOY ? 'hoy' : isTeacher ? 'teacher' : isParent ? 'parent' : 'student';

  return (
    <AuthContext.Provider value={{
      user, session, profile, roles, loading, signOut, refreshProfile,
      isAdmin, isTeacher, isStudent, isParent, isHOD, isHOY, primaryRole,
    }}>
      {children}
